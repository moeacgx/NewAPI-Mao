...
func UpdateUpstreamModelGuardConfig(c *gin.Context) {
	...
	recordManageAudit(c, "extension.upstream_model_guard.update", map[string]interface{}{"config_version": cfg.ConfigVersion, "enabled": cfg.Enabled, "rule_count": len(cfg.Rules)})
	common.ApiSuccess(c, cfg)
}
