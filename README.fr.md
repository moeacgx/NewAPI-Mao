...
<p align="center">
  ...
  --><a href="https://github.com/moeacgx/NewAPI-Mao/releases/latest">
    <img src="https://img.shields.io/github/v/release/moeacgx/NewAPI-Mao?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
> [!TIP]
> **Dernière image Docker:** `ghcr.io/moeacgx/maolaonewapi:latest`
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=moeacgx/NewAPI-Mao&type=Date)](https://star-history.com/#moeacgx/NewAPI-Mao&Date)
...
### 💖 Merci d'utiliser NewAPI-Mao

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.newapi.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/moeacgx/NewAPI-Mao/issues)** • **[Dernière version](https://github.com/moeacgx/NewAPI-Mao/releases)**
