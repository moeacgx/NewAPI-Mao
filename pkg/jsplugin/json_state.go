...
const (
	...
	CapabilityTaskPerformanceFilter = "task-performance-filter@1"
...
func HasCapability(name string) bool {
	return name == CapabilityJSONClone || name == CapabilitySubmitSSEDelta || name == CapabilityTaskPerformanceFilter
}
